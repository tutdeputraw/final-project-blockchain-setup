...
CC_SRC_PATH=${PWD}/../../artifacts/chaincodes/$CC_NAME
...
commitChaincodeDefination() {
    setGlobalsForPeer0Org1
    peer lifecycle chaincode commit -o $VM_4:7050 --ordererTLSHostnameOverride orderer.example.com \
