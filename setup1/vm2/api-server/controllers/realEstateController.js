...
const RealEstateController_GetByOpenToSellDetail = async (req, res) => {
    ...
    const functionArgs = [
        `{\"selector\": {\"realEstateModel_is_open_to_sell\": {\"$eq\": \"true\"},\"realEstateModel_id\": {\"$eq\": \"${realEstateId}\"}}}`,
        `${perPage}`,
        `${bookmark}`,
    ]
...
const RealEstateController_GetByOpenToSell = async (req, res) => {
    const contractName = 'real_estate';
    const functionName = 'Query';
    ...
    const functionArgs = [
        `{\"selector\":{\"realEstateModel_is_open_to_sell\":\"true\"}}`,
        `${perPage}`,
        `${bookmark}`,
    ]
...
module.exports = {
    ...
    RealEstateController_GetByOpenToSell,
    RealEstateController_GetByOpenToSellDetail,
